...
`/home/asus/Lakuna_remote/research_problems/imagenet_cnn`, runs `train.py` over
...
```text
/home/asus/Lakuna_remote/research_problems/imagenet_cnn/data/tiny-imagenet-200
```
...
`/home/asus/Lakuna_remote/venv/bin/python`, which should have PyTorch and
