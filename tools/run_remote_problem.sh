...
Options:
  ...
  --python PYTHON      Remote python executable, default: $ASUS_GX10_PYTHON
                      or /home/asus/Lakuna_remote/venv/bin/python
...
remote_python="${ASUS_GX10_PYTHON:-/home/asus/Lakuna_remote/venv/bin/python}"
...
if [[ -z "$remote_dir" ]]; then
  remote_dir="/home/asus/Lakuna_remote/$(basename "$PWD")"
fi
...
control_path="${TMPDIR:-/tmp}/lakuna-asus-%r@%h:%p"
ssh_opts=(
  -F "$ssh_config"
  -p "$port"
